...
if sys.platform == "win32":
    ...
    excludes = ['Cython', 'email', 'future', 'matplotlib', 'mpl_toolkits', 'pandas', 'pip', 'PyPDF2', 'PyQt4',
...
#                     (os.path.join(os.path.dirname(PYTHON_INSTALL_DIR), 'lib', 'site-packages', 'shapely', 'DLLs', 'geos_c.dll'), os.path.join('lib', 'geos_c.dll')),
                    (os.path.join(PYTHON_INSTALL_DIR, 'tcl', 'tk86t.dll'), os.path.join('lib', 'tk86t.dll')),
                    (os.path.join(PYTHON_INSTALL_DIR, 'tcl', 'tcl86t.dll'), os.path.join('lib', 'tcl86t.dll')),
